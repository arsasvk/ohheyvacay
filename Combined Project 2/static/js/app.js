...
console.log(`origin${origin}`)
 ...
 if (selchosenairline == 19805){chosenairline = 'AA'}
 else if(selchosenairline == 19930){chosenairline = 'AS'}
 else if(selchosenairline == 20409){chosenairline = 'B6'}
 else if(selchosenairline == 19790){chosenairline = 'DL'}
 else if(selchosenairline == 20366){chosenairline = 'EV'}
 else if(selchosenairline == 20436){chosenairline = 'F9'}
 else if(selchosenairline == 19690){chosenairline = 'HA'}
 else if(selchosenairline == 20304){chosenairline = 'OO'}
 else if(selchosenairline == 19977){chosenairline = 'UA'}
 else {chosenairline = 'WN'};
...
else
{
    ...
    chosenfare = fare;
    predictdiv.text(`Predicted Fare for ${chosenairline}: $${fare}`) ;  
...
var mapcontainer = d3.select("#mapcontainer").html("")
